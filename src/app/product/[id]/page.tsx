...
export default async function Product({
    ...
    return (
        <main className="flex flex-col gap-8 py-6 items-center sm:items-start">
            ...
            {
            product.length !== 0 &&
            <section id="productDetails" className="group grid grid-cols-[40%_60%] gap-4 w-[100%] max-h-[24rem] px-10">
                <div className="flex flex-col justify-center gap-2 max-w-[24rem] mb-[8rem] text-xl font-medium leading-6 text-slate-900">
                    <h1 className="w-fit text-5xl text-slate-900 font-semibold mx-6 mb-2 duration-100 group-hover:text-slate-500 group-hover:scale-110 group-hover:translate-x-[48px] group-hover:font-bold">
                        {prod.title}
                    </h1>
                    <div className="rounded-full w-[12rem] h-1 mx-6 mb-2 bg-slate-700 duration-150 group-hover:w-[16rem] group-hover:bg-slate-400" />
                ...
                <div className="relative max-w-[97%] h-[24rem] shadow-md shadow-slate-950 duration-150 hover:scale-105">
